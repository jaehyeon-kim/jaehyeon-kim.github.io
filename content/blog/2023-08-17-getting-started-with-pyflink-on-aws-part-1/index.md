...
The [Kpow CE](https://docs.factorhouse.io/kpow/getting-started) is used for ease of monitoring Kafka topics and related resources. The bootstrap server address is added as an environment variable. See [this post](/blog/2023-05-18-kafka-development-with-docker-part-2/) for details about Kafka management apps.
