---
title: Kafka Connect for AWS Services Integration - Part 2 Develop Camel DynamoDB Sink Connector Locally
date: 2023-06-04
draft: true
featured: false
comment: true
...
* [Part 2 Develop Camel DynamoDB Sink Connector Locally](#) (this post)
* Part 3 Deploy Camel DynamoDB Sink Connector on MSK Connect
* Part 4 Develop Firehose Connector for OpenSearch Sink Locally
* Part 5 Deploy Firehose Connector for OpenSearch Sink on MSK Connect
## Amazon
