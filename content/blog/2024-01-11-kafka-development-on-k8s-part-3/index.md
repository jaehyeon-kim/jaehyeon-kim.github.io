...
tags: 
  ...
  - Docker
  - Python
description: Ingest fake customer and order data into Kafka with the MSK Data Generator and save it to S3, with connectors deployed as Strimzi custom resources.
---
...
![Docker Hub tags page for the demo-connect repository, showing the latest tag pushed a few seconds ago at 323.92 MB](dockerhub.png#center "The Connect image pushed to the external registry")
...
![Kafka UI connectors page listing order-sink running the S3 sink class and order-source running the MSK data generator, both on the customer and order topics](connectors.png#center "Source and sink connectors running on the Connect cluster")

The sink connector writes messages of the two topics (*customer* and *order*), and topic names are used as S3 prefixes. 

![S3 console at the topics prefix, holding a customer folder and an order folder](s3-topics.png#center "Topic names used as S3 prefixes")
...
![S3 console inside the order partition 0 prefix, listing three JSON files named by topic, partition and start offset](s3-files.png#center "Output files named by topic, partition and start offset")
