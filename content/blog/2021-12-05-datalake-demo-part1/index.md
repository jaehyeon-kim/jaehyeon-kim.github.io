...
![Architecture flow from Aurora PostgreSQL through MSK Connect and EMR to Athena and Quicksight](00-01-architecture.png#center "Solution architecture")
...
![Northwind entity relationship diagram linking orders, order details, products, customers, employees and related tables](00-02-datalake-er.png#center "Northwind data model")
...
![Control center home page with one healthy cluster card showing one broker and 58 topics](01-confluent-cluster.png#center "Cluster card on the control center home page")
...
![Cluster overview with one broker, 58 topics, 220 partitions and one Connect cluster](02-confluent-overview.png#center "Cluster overview")
...
![Connectors page listing orders-source and orders-sink, both running as Postgres and S3 connectors](03-confluent-connectors.png#center "Source and sink connectors running")

In the _Topics_ menu, we are able to see that the _demo.datalake.cdc_events_ topic is created by the Debezium connector.

![Topics list with the CDC events topic highlighted as healthy alongside internal connect topics](04-confluent-topic-list.png#center "CDC events topic in the topic list")
...
![Messages tab of the CDC events topic showing offsets 291 to 297 and message fields](05-confluent-topic-messages.png#center "Browsing messages from offset zero")
...
![S3 console under customer RATTC and order 11077 holding a single 21.6 KB JSON object](06-01-message.png#center "Output file for order 11077")
...
![Same S3 prefix now holding two JSON objects after the shipped date update](06-02-s3-message-update.png#center "New output file after the update")
...
![S3 object for order 11075 with the first record showing null order items and products](07-new-message.png#center "Event records from a new order")
