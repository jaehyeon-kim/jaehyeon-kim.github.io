...
description: Real Time Streaming with Kafka and Flink updates an AWS workshop that builds a real time analytics app using Amazon Kinesis. A Kafka cluster on Amazon MSK is used instead and Flink (Pyflink) apps are used mainly for data processing. As an introduction, this post compares the workshop architecture with the updated architecture. The labs of the updated architecture will be implemented in subsequent posts.
---
...
## Architecture Based-on Kafka and MSF
