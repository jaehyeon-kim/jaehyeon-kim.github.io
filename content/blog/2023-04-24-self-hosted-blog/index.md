...
tags:
  ...
  - Docker Compose
  - GitHub Actions
description: Set up a self-managed blog with Hugo and GitHub Pages, including why Hugo was chosen over Jekyll and Pelican for its themes and features.
---
...
![Hugo Bootstrap starter site with a purple menu bar, a wide image carousel, a sample post and an author card](before.png#center "Site as generated by the starter template")
...
![The finished blog with a dark menu bar, post summaries with tags and Read More buttons, and a sidebar of categories and featured posts](after.png#center "Site after the configuration is reduced")
...
![Route 53 hosted zone for jaehyeon.me with four A records, four AAAA records and a CNAME from www to jaehyeon-kim.github.io](custom-domain-1.png#center "DNS records for the apex domain and the WWW subdomain")
...
![GitHub Pages settings deploying from the gh-pages branch, custom domain jaehyeon.me passing the DNS check, and Enforce HTTPS left unticked](custom-domain-2.png#center "Custom domain saved in the repository settings")
...
![GitHub account Pages settings listing jaehyeon.me under verified domains with a Verified badge](custom-domain-3.png#center "Custom domain verified on the account")
...
![Repository settings with the Discussions checkbox ticked and a Set up discussions button](discussion-1.png#center "Enabling Discussions on the repository")
...
![Discussions tab of the repository with the categories General, Ideas, Polls, Q and A, and Show and tell, and no discussions yet](discussion-2.png#center "Discussion categories available for comments")
...
![GitHub App page for giscus, described as a comments system powered by GitHub Discussions, with an Install button](giscus-1.png#center "Giscus app page on GitHub")

I only selected the repository for the blog site and clicked the *Install* button.

![Install giscus page with Only select repositories chosen and the blog repository selected, granting read and write access to discussions](giscus-2.png#center "Installing giscus on the blog repository only")
...
![Comments section on a post showing 0 comments and a disabled text area with a Sign in with GitHub button](comment-1.png#center "Comment widget before signing in")

Once signed in, the text area is enabled, and we can leave a comment.

![Comments section with the text area enabled, the words test comment typed, and a Comment button](comment-2.png#center "Leaving a comment after signing in")

The comment can also be checked on the *Discussion > General* of the repository and a reply can be made from it.

![GitHub discussion opened by the giscus bot for the post, holding the test comment and a reply being typed](comment-3.png#center "The comment stored as a repository discussion")

On the post page, we can see the reply

![Comments section on the post showing one comment and one reply, both by jaehyeon-kim, powered by giscus](comment-4.png#center "The reply appears back on the post page")
