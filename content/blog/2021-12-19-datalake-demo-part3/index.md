...
![Terminal after ssh to hadoop@10.100.22.160, showing the Amazon Linux 2 and EMR banners](ssh-bastion.png#center "Logged in to the EMR master instance over the VPN")
...
![Confluent Control Center schema tab for demo.datalake.cdc_events, Avro value schema version 1](avro-schema.png#center "Downloading the Avro value schema from the topic")
...
![EMR steps tab with step cdc-events-simple running for two minutes and its spark-submit arguments](steps.png#center "DeltaStreamer submitted as an EMR step")
...
![Glue catalogue listing tables cdc_events and cdc_events_simple in the datalake database](glue-tables-01.png#center "Two Hudi tables registered by the DeltaStreamer apps")
...
![Athena DESCRIBE output listing Hudi meta columns and partitions on customer_id and order_id](glue-tables-02.png#center "Table description in Athena, including the Hudi metadata columns")
...
![Pie chart of revenue by customer beside a scatter plot of average revenue against average quantity](dashboard.png#center "Demo dashboard built on the order items dataset")
