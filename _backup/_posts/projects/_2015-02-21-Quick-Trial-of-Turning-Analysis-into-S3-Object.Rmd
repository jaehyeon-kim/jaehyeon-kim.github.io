...
```{r construct, message=FALSE, warning=FALSE}
tom = emp("Tom")
alice = emp("Alice")
...
```{r type_checking, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r check_methods, message=FALSE, warning=FALSE}
...
```{r class_attribute, message=FALSE, warning=FALSE}
...
```{r rpartExt, message=FALSE, warning=FALSE}
## CART example
...
```{r rpartExt_print, message=FALSE, warning=FALSE}
# extend plot method
...
```{r cm, message=FALSE, warning=FALSE}
rpt.cl$test.lst$cm
```
