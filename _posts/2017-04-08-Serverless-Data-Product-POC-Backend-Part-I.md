...
* Backend
    ...
    * Deploying at AWS Lambda and exposing via Amazon API Gateway
* Frontend
...
This is all that I've prepared for this post and I hope you don't feel bored. The next post will be much more interesting as this package will be exposed via an API.
