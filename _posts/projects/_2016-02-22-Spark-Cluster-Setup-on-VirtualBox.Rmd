...
![center](C:\workspace\jaehyeon-kim.github.io\figs\2016-02-22-Spark-Cluster-Setup-on-VirtualBox\01_uuid_error.png)
...
![center](C:\workspace\jaehyeon-kim.github.io\figs\2016-02-22-Spark-Cluster-Setup-on-VirtualBox\021_mac_addr.png)

In my case, the master and slave machine's IP addresses are set up to be _192.168.1.8_ and _192.168.1.11_.

![center](C:\workspace\jaehyeon-kim.github.io\figs\2016-02-22-Spark-Cluster-Setup-on-VirtualBox\02_diff_ip.png)
...
![center](C:\workspace\jaehyeon-kim.github.io\figs\2016-02-22-Spark-Cluster-Setup-on-VirtualBox\03_hostnames.png)

Finally I added slave's host information to the master's _/etc/hosts_ and did the other way around to the slave's file.

![center](C:\workspace\jaehyeon-kim.github.io\figs\2016-02-22-Spark-Cluster-Setup-on-VirtualBox\04_etc_hosts.png)
...
![center](C:\workspace\jaehyeon-kim.github.io\figs\2016-02-22-Spark-Cluster-Setup-on-VirtualBox\05_webui.png)
