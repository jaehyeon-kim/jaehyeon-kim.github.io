...
```{r make_stop, message=FALSE, warning=FALSE}
...
```{r case_I_snow, message=FALSE, warning=FALSE}
# snow
require(snow)
set.seed(1237)
...
```{r case_I_par, message=FALSE, warning=FALSE}
# parallel
require(parallel)
set.seed(1237)
sleep = sample(1:10,10)
...
```{r case_II_snow, message=FALSE, warning=FALSE}
# snow
require(snow)
...
```{r case_II_par, message=FALSE, warning=FALSE}
# parallel
require(parallel)
mat = matrix(0, 2000, 2000)
sleep = rep(1,50)
