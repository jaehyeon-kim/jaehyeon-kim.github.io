...
```{r fit_rpart, message=FALSE, warning=FALSE}
### rpart
...
```{r rpart_cp_graph, message=FALSE, warning=FALSE}
# plot xerror vs cp
...
```{r rpart_fit_train, message=FALSE, warning=FALSE}
...
```{r mmce_rpart_fit, message=FALSE, warning=FALSE}
# fit to train data
mod.rpt.eq.lst.ftd = predict(mod.rpt.eq.lst, type="class")
mod.rpt.eq.bst.ftd = predict(mod.rpt.eq.bst, type="class")
...
```{r mmce_rpart_pred, message=FALSE, warning=FALSE}
...
```{r caret_fit, message=FALSE, warning=FALSE}
### caret
## train on training data
...
```{r caret_cp, message=FALSE, warning=FALSE}
# lowest CP
...
```{r cp_graph_caret, message=FALSE, warning=FALSE}
# CP by 1-SE rule
...
```{r caret_train, message=FALSE, warning=FALSE}
## performance on train data
...
```{r task_learner, message=FALSE, warning=FALSE}
### mlr
## task and learner
...
```{r mlr_tune, message=FALSE, warning=FALSE}
## tune parameter
...
```{r mlr_train, message=FALSE, warning=FALSE}
...
```{r mlr_update, message=FALSE, warning=FALSE}
# fitted responses
...
```{r mmce_plot, message=FALSE, warning=FALSE}
# mmce vs cp
ftd.mmce = c()
ptd.mmce = c()
