...
```{python handler_setup, eval=FALSE}
import ctypes
import json
import os
import boto3
...
```{python handler_funs, eval=FALSE}
...
```{python handler_handler, eval=FALSE}
...
```{python handler_test, eval=FALSE}
import unittest
import handler
